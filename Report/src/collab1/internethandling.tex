...
\node [firkant] (v9) at (8,-1) {Make a toast\footnote{A toast is a small message on the screen \citep{androidtoast}. The GToast, which is a customization of the Android toast, is used.}\\ with error message };
