...
The button can be seen in \figref{fig:clear-button}. We decide the icon of a trash can to be the most fitting, as it is our understanding that most people associate the trash can icon with throwing something away.
