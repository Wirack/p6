...
Since \eqref{eq:isolated-h} is based on given vectors and lengths, and the variables given in the application are coordinates, we have to change the formula to calculate the vectors and lengths from the coordinates.
