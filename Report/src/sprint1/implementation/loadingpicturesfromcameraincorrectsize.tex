\subsection{Loading Pictures from Camera in Suitable Size}
...
The new constructor, seen in \lstref{lst:BitmapEnity-Constructor-New}, is similar to the old constructor but with the option of including a scale factor as input that is used to change the width and height of the picture by this factor.
